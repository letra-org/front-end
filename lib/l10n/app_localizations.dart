...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'account': 'Account',
      'security': 'Security',
      'security_subtitle': 'Change password, 2-factor authentication',
      ...
      'english': 'English',
      'user_photos_page_title': 'Your Photos',
      'user_photos_page_body': 'This is your photos page.',
    ...
    'vi': {
      ...
      'account': 'Tài khoản',
      'security': 'Bảo mật',
      'security_subtitle': 'Đổi mật khẩu, xác thực 2 lớp',
      ...
      'vietnamese': 'Tiếng Việt',
      'english': 'English',
      'user_photos_page_title': 'Ảnh của bạn',
      'user_photos_page_body': 'Đây là trang ảnh của bạn.',
